...
const RAW_SCREENSHOT_PATH: &'static str = "drive/screenshots";

// path of scaled cart screenshots
const SCREENSHOT_PATH: &'static str = "drive/carts/screenshots";
...
pub fn screenshot2cart<W: Write>(png_path: &str, writer: &mut W) -> anyhow::Result<()> {
